 ...
 *
 * The launcher deliberately does NOT touch the display refresh rate: it never requests a mode
 * or a preferred rate, so the system's own auto-refresh fully governs it (like a stock
 * launcher). This avoids any chance of pinning the panel to a high rate.
 */
@AndroidEntryPoint
